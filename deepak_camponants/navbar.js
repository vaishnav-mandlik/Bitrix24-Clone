function navbar(){
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
      <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
        ...
        <button class="btn my-2 my-sm-0" type="submit">START FOR FREE</button>
        <a href="#">LOG IN</a>
        <a href="#">EN</a>
    </div>
  </nav>`
